...
public class BattleshipGame {
	...
	public static void main(String[] args) {
		...
		int undetectedsShipNumber = shipNumber;
		while (undetectedsShipNumber > 0) {

			int[] guessCoordinates = getUserCoordinates(gameBoardLength);
			char locationViewUpdate = evaluateGuessandGetTheTarget(guessCoordinates, gameBoard, ship, water, hit, miss); // we want to know what we want to print on our gameboard
			if (locationViewUpdate == hit) {

				undetectedsShipNumber--;
			}
