...
public abstract class Player implements Comparable<Player> {
    ...
    /** This is a default constructor, which probably won't be used */
    public Player(){
        // default constructor
        this.name = "";
        this.susLevel = 0;
    ...
    public Player(String name, int susLevel) {
        ...
        if (players == null) {
            ...
            int length = players.length + 1; // increase size of players array by 1 to accommodate new player
            Player[] temp = players; // temporary array copy of players array
            players = new Player[length]; // size of array has been expanded
            for (int i = 0; i < temp.length; i++) {
                players[i] = temp[i]; // placeholder to 
            }
    ...
    /**
     * This method is the cdompareTo method from the Comparable interface.
    ...
    public int compareTo(Player p) {
        if(this.susLevel > p.susLevel) {return 1;}
        else if(this.susLevel < p.susLevel) {return -1;}
        else {return 0;} // delete this once you have implemented this method
    }
